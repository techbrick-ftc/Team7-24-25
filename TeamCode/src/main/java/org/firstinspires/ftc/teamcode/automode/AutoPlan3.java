...
@Autonomous()
public class AutoPlan3 extends OpMode{
    ...
    public void loop() {
        ...
        //runtime.reset();
        //autodrive.liftMotor.setPower(-1);timeSec = 0.5;
        //if (runtime.seconds() > timeSec) {
            //autodrive.liftMotor.setPower(0);
        //}
        ...
        switch (state) {
            ...
            case 2:
                ...
                break;
            case 3:
                forward = -14.0; right = 0.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 4:
                forward = 0.0; right = 20.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 5:
                forward = 30.0; right = 0.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 6:
                forward = 0.0; right = 0.0; rotate = 180.0;timeSec = 2.5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 7:
                forward = 0.0; right = -12.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 8:
                forward = 46.0; right = 0.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
                ...
                break;
            case 9:
                forward = -10.5; right = 0.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
