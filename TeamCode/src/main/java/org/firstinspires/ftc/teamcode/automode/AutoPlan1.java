...
@Autonomous()
public class AutoPlan1 extends OpMode{
        ...
        switch (state) {
            ...
            case 0:
                ...
                while(runtime.seconds() < timeSec) {
                    ...
                    autodrive.setArmPosition(2, currentPosition);
                }
                state = 1;
                break;
            case 1:
                forward = 32.0; right = 0.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
            ...
            case 2:
                ...
                break;
            case 3:
                forward = 0.0; right = 0.0; rotate = 0.0;timeSec = 1.1;
                runtime.reset();
            ...
            case 4:
                ...
                break;
            case 5:
                forward = 0.0; right = -27.0; rotate = 0.0;timeSec = 5;
                stateOp = "--> "+autodrive.driveByTimeToString(forward,right,rotate,timeSec);
                telemetry.addData("Auto State: %d "+stateOp,state);
                telemetry.update();
                //autodrive.setDriveByTime(forward,right,rotate,timeSec);
